...
This fork runs an automated Trivy/Slack vulnerability scanning and
remediation-reporting pipeline that detects CRITICAL dependency vulnerabilities
and measures how effectively they are remediated over time. See
[`.github/scripts/README.md`](.github/scripts/README.md) for the full
